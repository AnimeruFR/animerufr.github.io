<template>
  <div class="page wrap">
    <span class="eyebrow">{{ t('nav.lieux') }}</span>
    <h1 class="ttl">Les <span class="accent">Lieux</span></h1>
    <p class="sub">Villes, domaines et territoires clés de l'univers de Re:Zero.</p>
